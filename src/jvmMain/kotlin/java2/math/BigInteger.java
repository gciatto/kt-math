...
public class BigInteger extends Number implements Comparable<BigInteger> {
    ...
    public float floatValue() {
         ...
         */
        int shift = exponent - FloatConsts.INSTANCE.getSIGNIFICAND_WIDTH();
        ...
        signifFloor &= FloatConsts.INSTANCE.getSIGNIF_BIT_MASK(); // remove the implied bit
        ...
        int bits = ((exponent + FloatConsts.INSTANCE.getEXP_BIAS()))
                << (FloatConsts.INSTANCE.getSIGNIFICAND_WIDTH() - 1);
        bits += signifRounded;
        /*
         ...
         */
        bits |= signum & FloatConsts.INSTANCE.getSIGN_BIT_MASK();
    ...
    public double doubleValue() {
         ...
         * 2^(SIGNIFICAND_WIDTH - 1 - exponent).
         */
        int shift = exponent - DoubleConsts.INSTANCE.getSIGNIFICAND_WIDTH();
        ...
        signifFloor &= DoubleConsts.INSTANCE.getSIGNIF_BIT_MASK(); // remove the implied bit
        ...
        long bits = (long) ((exponent + DoubleConsts.INSTANCE.getEXP_BIAS()))
                << (DoubleConsts.INSTANCE.getSIGNIFICAND_WIDTH() - 1);
        bits += signifRounded;
        /*
         ...
         */
        bits |= signum & DoubleConsts.INSTANCE.getSIGN_BIT_MASK();
