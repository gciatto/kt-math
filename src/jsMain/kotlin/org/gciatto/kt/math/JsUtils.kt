...
internal actual inline fun <T, reified U : T> T?.castTo(): U = this.unsafeCast<U>()

internal actual fun bigProbablePrimeInteger(
    bitLength: Int,
    rnd: Random,
): BigInteger = CommonBigInteger.probablePrime(bitLength, rnd)
...
internal actual fun bigIntegerOf(
    value: String,
    radix: Int,
): BigInteger = CommonBigInteger.of(value, radix)
...
internal actual fun bigDecimalOf(
    unscaledVal: Long,
    scale: Int,
): BigDecimal = CommonBigDecimal.of(unscaledVal, scale)

internal actual fun bigDecimalOf(
    unscaledVal: Long,
    scale: Int,
    prec: Int,
): BigDecimal = CommonBigDecimal.of(unscaledVal, scale, prec)
...
internal actual fun bigDecimalOf(
    ...
    scale: Int,
    prec: Int,
): BigDecimal = CommonBigDecimal.of(intVal.castTo<BigInteger, CommonBigInteger>(), scale, prec)
